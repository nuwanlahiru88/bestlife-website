...
function revslider_showDoubleJqueryError(e) {
    ...
    t += "<br><br> To fix it you can:<br>&nbsp;&nbsp;&nbsp; 1. In the Slider Settings -> Troubleshooting set option:  \n\
<strong><b>Put JS Includes To Body</b></strong> option to true.";
...
(function (e, t) {
    ...
    function y(t, n) {
        ...
        var o = r.find("#topleft");
        var u = r.find("#topright");
    ...
    function w(n, r) {
        ...
        n.find("#topright").each(function (n) {
            var i = e(this);
            ...
            i.wrap('<div class="slotholder" style="width:100%;height:100%;"' +
                    ...
                    'data-zoomend="' + i.data("zoomend") + '"' + 'data-rotationstart="' + i.data("rotationstart") +
                    ...
                    i.data("bgfit") + '"' + 'data-bgfitend="' +
                    i.data("bgfitend") + '"' + 'data-owidth="' +
                    i.data("owidth") + '"' + 'data-oheight="' +
                    i.data("oheight") + '"' + "></div>");
            ...
            if (o(8)) {
                ...
                c.find(".tp-bgimg").append('<img class="ieeightfallbackimage defaultimg" src="' + 'Trangle_Images/Trangle_ImgID3.jpg' + '" style="width:100%">')
            }
            i.css({opacity: 0});
            i.data("li-id", n)
        })
        ...
        n.find(">ul:first >li >img").each(function (n) {
            ...
            if (l == t)
                l = "center center";
            var c = i.closest(".slotholder");
            if (s == "images/slide1bg.jpg") {

                i.replaceWith('<div class="tp-bgimg defaultimg" data-lazyload="' + i.data("lazyload") + '" data-bgfit="' + a + '"data-bgposition="' + l + '" data-bgrepeat="' + f + '" data-lazydone="' + i.data("lazydone") + '" data-src="' + s + '" style="background-color:' + i.css("backgroundColor") + ";background-repeat:" + f + ";background-image:url(" + s + ");background-size:" + a + ";background-position:" + l + ';width:100%;height:100%;"></div>');
                
             //  alert(s);
               ChangeImage1(s);
               ChangeImage("Trangle_Images/right1.jpg");
              //  ChangeImage1("Trangle_Images/right1.jpg");
                
    //        $("#topleft").attr("xlink:href",  "Trangle_Images/left1.jpg");
    //        $("#topright").attr("xlink:href", "Trangle_Images/right1.jpg");
    //           $("#topleft").css("background-image", "url(" +"Trangle_Images/left1.jpg" + ")");
    //           $("#topright").css("background-image", "url(" +"Trangle_Images/left1.jpg" + ")");
                
            } else if (s == "images/slide2bg.jpg") {

                i.replaceWith('<div class="tp-bgimg defaultimg" data-lazyload="' + i.data("lazyload") + '" data-bgfit="' + a + '"data-bgposition="' + l + '" data-bgrepeat="' + f + '" data-lazydone="' + i.data("lazydone") + '" data-src="' + s + '" style="background-color:' + i.css("backgroundColor") + ";background-repeat:" + f + ";background-image:url(" + s + ");background-size:" + a + ";background-position:" + l + ';width:100%;height:100%;"></div>');
              
             
                ChangeImage1(s);
                ChangeImage("Trangle_Images/right3.jpg");
              //  $("#topleft").fadeIn(500);
              
//                alert(s);
//                ChangeImage("Trangle_Images/left1.jpg");
//                ChangeImage1("Trangle_Images/right1.jpg");
                
//                $("#topleft").attr("xlink:href",  "Trangle_Images/left1.jpg");
//                $("#topright").attr("xlink:href", "Trangle_Images/right1.jpg");
               
            } else if (s == "images/slide3bg.jpg") {
...
//                ChangeImage1("Trangle_Images/right1.jpg");
   ...
   //             $("#topright").attr("xlink:href", "Trangle_Images/right1.jpg");
            ...
            } else if (s == "images/slide4bg.jpg") {

                i.replaceWith('<div class="tp-bgimg defaultimg" data-lazyload="' + i.data("lazyload") + '" data-bgfit="' + a + '"data-bgposition="' + l + '" data-bgrepeat="' + f + '" data-lazydone="' + i.data("lazydone") + '" data-src="' + s + '" style="background-color:' + i.css("backgroundColor") + ";background-repeat:" + f + ";background-image:url(" + s + ");background-size:" + a + ";background-position:" + l + ';width:100%;height:100%;"></div>');
//                alert(s);
             //   ChangeImage1("Trangle_Images/left1.jpg","Trangle_Images/right1.jpg");
                
     //           $("#topleft").attr("xlink:href",  "Trangle_Images/left1.jpg");
     //           $("#topright").attr("xlink:href", "Trangle_Images/right1.jpg");
                
            } else if (s == "images/slide5bg.jpg") {
...
//                    alert(v);
    ...
    function C(n, r) {
      ...
      i.css({"z-index": 18});
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            if (d != 1) {
                if (l == 12)
                    TweenLite.to(J, $, {left: 0 - D + "px", scale: R, opacity: I, rotation: r.rotate, ease: z});
                else if (l == 15)
                    TweenLite.to(J, $, {left: D + "px", scale: R, opacity: I, rotation: r.rotate, ease: z});
                else if (l == 13)
                    TweenLite.to(J, $, {top: 0 - H + "px", scale: R, opacity: I, rotation: r.rotate, ease: z});
                else if (l == 14)
                    TweenLite.to(J, $, {top: H + "px", scale: R, opacity: I, rotation: r.rotate, ease: z})
            }
            u.css({opacity: 1})
        }
        if (l == 16) {
            ...
            if (i.html() != null)
                TweenLite.fromTo(u, (N - 200) / 1e3, {opacity: 0, scale: .8, x: r.width * Z, y: H * et, rotation: Y, transformPerspective: 600, transformOrigin: "center center"}, {rotation: 0, scale: 1, x: 0, y: 0, opacity: 1, ease: Power2.easeInOut});
    ...
    function H(t) {
        ...
        if (t.data == YT.PlayerState.PLAYING) {
            ...
            if (t.data != -1) {
                if (u.conthover == 0)
                    o.animate({width: "100%"}, {duration: u.delay - u.cd - 100, queue: false, easing: "linear"});
    ...
    function F(n, r) {
        ...
        n.on("pause", function () {
            ...
            var t = e.data("opt");
            if (t.conthover == 0)
                e.animate({width: "100%"}, {duration: t.delay - t.cd - 100, queue: false, easing: "linear"});
                    ...
                    if (f.data("linktoslide") != "no") {
                        f.click(function () {
                            ...
                            if (n != "next" && n != "prev") {
                                ...
                                r.container.parent().find("#topright").click()
                            } else if (n == "next")
                                r.container.parent().find("#topright").click();
                            else if (n == "prev")
                                r.container.parent().find("#topleft").click()
                        })
                    }
                }
                if (s < 0)
                            ...
                            if (!n.hasClass("HasListener")) {
                                try {
                                    ...
                                    if (f.data("autoplay") == true)
                                        s = new YT.Player(c, {events: {onStateChange: H, onReady: function (e) {
                                                    e.target.playVideo()
                                                }}});
                                    else
                ...
                if (f.find("img").length > 0) {
                    ...
                    if (f.find("iframe").length > 0 || f.find(".video-js").length > 0) {
                        ...
                        if (w > r.startheight)
                            w = r.startheight;
                        if (!f.hasClass("fullscreenvideo"))
                            f.css({"font-size": y.data("fsize") * r.bw + "px", "padding-top": y.data("pt") * r.bh + "px", "padding-bottom": y.data("pb") * r.bh + "px", "padding-left": y.data("pl") * r.bw + "px", "padding-right": y.data("pr") * r.bw + "px", "margin-top": y.data("mt") * r.bh + "px", "margin-bottom": y.data("mb") * r.bh + "px", "margin-left": y.data("ml") * r.bw + "px", "margin-right": y.data("mr") * r.bw + "px", "border-top": y.data("bt") * r.bh + "px", "border-bottom": y.data("bb") * r.bh + "px", "border-left": y.data("bl") * r.bw + "px", "border-right": y.data("br") * r.bw + "px", "line-height": y.data("lh") * r.bh + "px", height: g * r.bh + "px", "white-space": "nowrap"});
                        else {
                            s = 0;
                            o = 0;
                            f.data("x", 0);
    ...
    e.fn.extend({revolution: function (i) {
            ...
            return this.each(function () {
                ...
                if (!u.hasClass("revslider-initialised")) {
                    ...
                    u.find(".tp-scrollbelowslider").on("click", function () {
                        ...
                        e("body,html").animate({scrollTop: u.offset().top + u.find(">ul >li").height() - t + "px"},
                        {duration: 400})
                    })
                }
            })
            ...
            return this.each(function () {
                var n = e(this);
                e("body,html").animate({scrollTop: n.offset().top + n.find(">ul >li").height() - t + "px"},
                {duration: 400})
            })
        ...
        , revnext: function (t) {
            return this.each(function () {
                var t = e(this);
                t.parent().find("#topright").click()
            })
        }, revprev:
                function (t) {
                    return this.each(function () {
                        var t = e(this);
                        t.parent().find("#topleft").click()
                    })
